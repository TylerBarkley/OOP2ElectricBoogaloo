...
public class PowerPlantManagerTest {
    ...
    public void FarmManager_Test(){
        ...
        powerPlant.unassign();
        powerPlantManager.setHarvestingEnergyLocation(loc1);
        assertEquals(10, powerPlantManager.getNumOfWorkers_Unassigned());
        assertEquals(0, powerPlantManager.getNumOfWorkers_HarvestingEnergy());
        assertEquals(100, r1.getEnergyLevel());
        powerPlant.assignWorkersToPowerPlant(loc1, 6);
        assertEquals(5, powerPlantManager.getNumOfWorkers_HarvestingEnergy());
