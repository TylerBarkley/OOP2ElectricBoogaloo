...
public class MineManagerTest {
    ...
    public void FarmManager_Test(){
        ...
        mine.unassign();
        mineManager.setHarvestingOreLocation(loc1);
        assertEquals(10, mineManager.getNumOfWorkers_Unassigned());
        assertEquals(0, mineManager.getNumOfWorkers_HarvestingOre());
        assertEquals(100, r1.getFoodLevel());
        mine.assignWorkersToMine(loc1, 6);
        assertEquals(5, mineManager.getNumOfWorkers_HarvestingOre());
